...
@Composable
fun HomeScreen(viewModel: ExploreViewModel = viewModel(), currentUser: User) {
            ...
            Row(
                ...
                Column(
                    ...
                    Row(modifier = Modifier.fillMaxWidth().padding(4.dp),
                        ...
                        Column {
                            Image(
                                painter = painterResource(id = R.drawable.baseline_backup_24), // Replace with actual image resource
